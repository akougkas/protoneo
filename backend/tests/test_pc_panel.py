"""Tests for the PC Panel product layer."""
...
from applications.pc_panel.conference import ConferenceProfile, load_profile, list_profiles
from applications.pc_panel.prompts import (
    assemble_system_prompt,
    load_prompt_pack,
    load_role_prompt,
    load_shared_prompt,
)
from applications.pc_panel.review import (
    _extract_json,
    build_agent_configs,
...
from applications.pc_panel.schemas import IndividualReview, MetaReview, ReviewPacket
...
class TestReviewOrchestration:
    ...
    def test_meta_gets_more_tokens(self):
        ...
        assert configs["technical"].max_tokens == 16384
...
class TestOutputParsing:
    ...
    def test_parse_structured_review(self):
        ...
        assert review.reviewer_role == "Technical Depth Reviewer"
...
class TestPreflight:
    ...
    def test_page_estimate_within_limit(self):
        from applications.pc_panel.preflight import run_preflight
...
class TestMarkdownExport:
    def test_renders_header(self):
        from applications.pc_panel.export import packet_to_markdown
        from applications.pc_panel.schemas import ReviewPacket
        packet = ReviewPacket(
            session_id="abc123",
            conference="hpdc26",
    ...
    def test_renders_reviews(self):
        from applications.pc_panel.export import packet_to_markdown
        from applications.pc_panel.schemas import IndividualReview, ReviewPacket
        packet = ReviewPacket(
            session_id="abc",
            conference="hpdc26",
            reviews=[
    ...
    def test_renders_meta_review(self):
        from applications.pc_panel.export import packet_to_markdown
        from applications.pc_panel.schemas import MetaReview, ReviewPacket
        packet = ReviewPacket(
            session_id="abc",
            conference="hpdc26",
...
class TestPdfExport:
    def test_generates_pdf_bytes(self):
        from applications.pc_panel.export import packet_to_pdf
        from applications.pc_panel.schemas import ReviewPacket, IndividualReview
        packet = ReviewPacket(
            session_id="pdf-test",
            conference="hpdc26",
