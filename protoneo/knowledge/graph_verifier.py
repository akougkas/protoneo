...
async def verify_graph(
    ...
    sys_prompt = (domain_config.verify_system_prompt if domain_config and domain_config.verify_system_prompt
                  else _VERIFY_SYSTEM)
    conn_prompt = (domain_config.verify_connectivity_prompt if domain_config and domain_config.verify_connectivity_prompt
                   else _VERIFY_CONNECTIVITY_PROMPT)
    comp_prompt = (domain_config.verify_completeness_prompt if domain_config and domain_config.verify_completeness_prompt
                   else _VERIFY_COMPLETENESS_PROMPT)
